    ...
    <div class="layui-col-md10">
        <div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
            ...
            <script type="text/html" id="currentTableBar">
                <a class="layui-btn layui-btn-normal layui-btn-xs data-count-edit" lay-event="SeeRes">查看结果</a>
            </script>
        </div>
    </div>
</div>
...
<script>
    ...
    layui.use(['form', 'table', 'tree', 'util', 'element'], function () {
        ...
        function getData() {
            var data = [];
            $.ajax({
                url: "${pageContext.request.contextPath}/res/selectTree",    //后台数据请求地址
                type: "get",
                async: false,
        ...
        table.render({
            elem: '#currentTableId',
            url: '${pageContext.request.contextPath}/res/findAll',//查询数据
            toolbar: '#toolbarDemo',
            ...
            cols: [[
                ...
                {field: 'evaname', width: 150, title: '评估人'},
        ...
        table.on('tool(currentTableFilter)', function (obj) {
            ...
            if (obj.event === 'SeeRes') {  // 监听修改操作
                var index = layer.open({
                    ...
                    shadeClose: true,
                    area: ['100%', '100%'],
                    content: '${pageContext.request.contextPath}/AssessResMain?id=' + data.id,
                });
